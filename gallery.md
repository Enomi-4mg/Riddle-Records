...
{% for item in sorted_gallery %}
  <div class="gallery-item journal-entry-animate" data-date="{{ item.date }}" data-categories="{{ item.categories | join: ',' }}">
